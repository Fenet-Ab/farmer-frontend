...
const CreateUser = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-white to-lime-50 flex items-center justify-center p-4 md:p-8'>
      <div
        className={`fixed left-0 top-[60px] h-[calc(100vh-40px)] w-64 z-40 overflow-y-auto transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
          } md:translate-x-0`}
      >

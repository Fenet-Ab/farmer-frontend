                ...
                <div className="px-7 pb-8 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className={`px-3 py-1.5 rounded-full text-[10px] font-black border ${p.stock > 0 ? 'border-emerald-100 text-emerald-600 bg-emerald-50' : 'border-rose-100 text-rose-600 bg-rose-50'
                        }`}>

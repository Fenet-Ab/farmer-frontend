    ...
    <aside className={`bg-white   h-full mt-4 border-r border-gray-200`}>
      <div className={`transition-all duration-300  ${collapsed ? 'w-16' : 'w-64'} h-full overflow-hidden`}>
        ...
        <nav className='p-2 space-y-2'>
          <Link
            to='/'
            className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${isActive('/')
          ...
          <Link
            to='/products'
            className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${isActive('/products')
                ? 'bg-emerald-50 text-emerald-700 font-semibold'
                : 'text-gray-700 hover:bg-emerald-50'
              }`}
          >
          ...
          <Link
            to='/cart'
            className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${isActive('/cart')
                ? 'bg-emerald-50 text-emerald-700 font-semibold'
                : 'text-gray-700 hover:bg-emerald-50'
              }`}
          >

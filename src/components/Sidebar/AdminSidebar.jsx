        ...
        <nav className='p-3'>
          <ul className='space-y-2'>
            <li>
              <Link
                to='/admin-dashboard'
                className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${isActive('/admin-dashboard')
            ...
            <li>
              <Link
                to='/product-detail'
                className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${isActive('/product-detail')
                    ? 'bg-emerald-50 text-emerald-700 font-semibold'
                    : 'text-gray-700 hover:bg-emerald-50'
                  }`}
              >
            ...
            <li>
              <Link
                to='/user-controller'
                className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${isActive('/user-dashboard')
                    ? 'bg-emerald-50 text-emerald-700 font-semibold'
                    : 'text-gray-700 hover:bg-emerald-50'
                  }`}
              >
            ...
            <li>
              <Link
                to='/order-detail'
                className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 relative ${false
                    ? 'bg-emerald-50 text-emerald-700 font-semibold'
                    : 'text-gray-700 hover:bg-emerald-50'
                  }`}
              >
